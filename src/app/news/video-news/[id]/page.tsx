...
const videoNews = [
  {
    ...
    content: `Эрүүл мэндийн салбарын шинэ төслийн танилцуулга видео бичлэг. Энэхүү төсөл нь эрүүл мэндийн салбарын үйлчилгээг сайжруулах, хүн амын эрүүл мэндийн түвшинг дээшлүүлэх зорилготой юм.
    ...
    Төсөл 2024 оны 6-р сараас эхлэн хэрэгжиж эхлэхээр төлөвлөгдсөн байна.`,
    date: "2024-03-15",
  ...
  },
  {
    ...
    content: `Эмнэлгийн үйлчилгээний шинэчлэлийн талаарх мэдээлэл. Энэхүү шинэчлэл нь эмнэлгийн үйлчилгээний чанарыг сайжруулах, үйлчлүүлэгчдийн сэтгэл ханамжийг дээшлүүлэх зорилготой юм.

    Шинэчлэлийн үндсэн чиглэлүүд:
    - Үйлчилгээний процесс
    - Тоног төхөөрөмжийн шинэчлэл
    - Ажилтны мэргэжил
    - Үйлчлүүлэгчдийн сэтгэл ханамж
    
    Шинэчлэл 2024 оны 7-р сараас эхлэн хэрэгжиж эхлэхээр төлөвлөгдсөн байна.`,
    date: "2024-03-10",
    image: "/branding/consultation.jpg",
    category: "Видео мэдээ",
    type: "website",
  ...
  },
  {
    ...
    content: `Эрүүл мэндийн салбарын сүүлийн үеийн тайлан. Энэхүү тайланд эрүүл мэндийн салбарын сүүлийн үеийн үйл ажиллагаа, үр дүн, чиг хандлага зэргийг тусгасан болно.
...
export default function VideoNewsDetailPage() {
  const params = useParams<{ id: string }>();
  const news = videoNews.find((item) => item.id === params.id);
      ...
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-xl px-6 py-12 mb-16">
        ...
        <div className="mb-8">
          <Breadcrumbs aria-label="breadcrumb" className="text-sm">
            ...
            <Link color="inherit" href="/news/video-news" className="text-sm">
              Видео мэдээ
            </Link>
        ...
        <article>
          ...
          {news.type === "youtube" && news.youtubeUrl && (
          ...
          {news.type === "website" && news.websiteUrl && (
            <div className="mt-8 border-t pt-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">
                Цахим холбоос
              </h2>
