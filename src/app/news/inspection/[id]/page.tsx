...
const inspectionNews = [
  ...
  {
    id: "2",
    title: "Хяналт шалгалтын шинэ дүрэм",
    description: "Хяналт шалгалтын шинэ дүрэм батлагдлаа.",
    content: "Хяналт шалгалтын шинэ дүрэм батлагдлаа.",
    date: "2024-03-10",
    image: "/branding/consultation.jpg",
    category: "Хяналт шалгалт",
    pdfUrl: null,
      ...
      <div className="w-full max-w-6xl px-6 py-12 mt-10 mb-16">
        ...
        <div className="mb-8">
          <Breadcrumbs aria-label="breadcrumb" className="text-sm">
            ...
            <Link color="inherit" href="/news/inspection" className="text-sm">
        ...
        <article>
          ...
          {/* PDF Viewer - Only shown when pdfUrl exists */}
          {news.pdfUrl && (
        ...
        <div className="mt-12 text-center">
          <Link
            href="/news/inspection"
            className="inline-flex items-center px-6 py-3 bg-[#00b1ad] text-white rounded-lg transition-colors hover:bg-[#00b1ad]/90"
          >
            <svg
              className="w-5 h-5 mr-2"
              fill="none"
